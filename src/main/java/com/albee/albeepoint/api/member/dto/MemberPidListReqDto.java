...
public class MemberPidListReqDto {
    @Schema(description = "기관코드", requiredMode = REQUIRED, maxLength = 20, example = "ORG001")
    private String orgCd;

    @Schema(description = "회원 식별자", requiredMode = NOT_REQUIRED, maxLength = 100, example = "ccc001")
    private String pid;
    ...
    public MemberPidListReqDto(String orgCd, String pid) {
        this.orgCd = orgCd;
        this.pid = pid;
    }
    ...
    @JsonIgnore
    public MemberPidListReqDto getIVo(){
        return (MemberPidListReqDto) ComUtil.votoivoCopy(this);
    }
}